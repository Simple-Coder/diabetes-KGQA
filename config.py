...
class Args:
    train_path = './data/json/train_process.json'
    test_path = './data/json/test_process.json'
    seq_labels_path = './data/json/intents.txt'
    token_labels_path = './data/json/slots.txt'
