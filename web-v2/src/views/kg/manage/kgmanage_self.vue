<template>
  ...
  <div style="position: absolute; width: 100%; height:100%">
    <kgecharts :options="kgoptions1" :width="kgwidth" :height="kgheight" @clickNode="clickNode1" @dblclickNode="clickNode2" />
      ...
      <div style="width: 500px; padding: 0px 2px;">
        <my-panel title="Operation" theme="background" icon="el-icon-s-tools">
          <el-input
            ...
            clearable
          >
            <i slot="suffix" class="el-input__icon el-icon-caret-right" @click="cypherSearch" />
          </el-input>
          <div class="demo-button" style="padding: 10px 10px;">
              ...
              <el-col :span="20">
                <div>
                  ...
                  <my-dialog
                    ...
                    @cancel="dialogClose"
                  >
                    <el-form ref="ruleForm0" :label-position="labelPosition" label-width="120px" :model="formLabelAlign" :rules="rules">
                      <el-form-item label="头节点标签">
                        <el-input v-model="formLabelAlign.label" clearable />
                      </el-form-item>
                      <el-form-item label="条件(Key:Value)">
                        <el-input v-model="formLabelAlign.whereAttribute" clearable />
                      </el-form-item>
                      <el-form-item label="尾节点标签">
                        <el-input v-model="formLabelAlign.tlabel" clearable />
                      </el-form-item>
                      <el-form-item label="条件(Key:Value)">
                        <el-input v-model="formLabelAlign.twhereAttribute" clearable />
                      </el-form-item>
                      <el-form-item label="关系类型">
                        <el-input v-model="formLabelAlign.rtype" clearable />
                      </el-form-item>
                      <el-form-item label="条件(Key:Value)">
                        <el-input v-model="formLabelAlign.rwhereAttribute" clearable />
                      </el-form-item>
                    </el-form>
                  </my-dialog>
                </div>
              ...
              <el-col :span="20">
                <div>
                  ...
                  <my-dialog
                    ...
                    @cancel="dialogClose"
                  >
                    <el-form ref="ruleForm1" :label-position="labelPosition" label-width="120px" :model="formLabelAlign" :rules="rules">
                      <el-form-item label="标签" prop="label">
                        <el-input v-model="formLabelAlign.label" clearable />
                      </el-form-item>
                      <el-form-item label="属性(Key:Value)" prop="attribute">
                        <el-input v-model="formLabelAlign.attribute" clearable />
                      </el-form-item>
                    </el-form>
                  </my-dialog>
                  <my-dialog
                    ...
                    @cancel="dialogClose"
                  >
                    <el-form ref="ruleForm2" :label-position="labelPosition" label-width="120px" :model="formLabelAlign" :rules="rules">
                  ...
                  <my-dialog
                    ...
                    @cancel="dialogClose"
                  >
                    <el-form ref="ruleForm3" :label-position="labelPosition" label-width="80px" :model="formLabelAlign" :rules="rules">
                      <el-form-item label="节点id" prop="id">
                        <el-input v-model="formLabelAlign.id" clearable />
                      </el-form-item>
                    </el-form>
                  ...
                  <my-dialog
                    ...
                    @cancel="dialogClose"
                  >
                    <el-form ref="ruleForm4" :label-position="labelPosition" label-width="120px" :model="formLabelAlign" :rules="rules">
                      <el-form-item label="标签" prop="label">
                        <el-input v-model="formLabelAlign.label" clearable />
                      </el-form-item>
                      <el-form-item label="条件(Key:Value)">
            ...
            <el-row>
              ...
              <el-col :span="20">
                ...
                <my-dialog
                  ...
                  @cancel="dialogClose"
                >
                  <el-form ref="ruleForm5" :label-position="labelPosition" label-width="120px" :model="formLabelAlign" :rules="rules">
                    <el-form-item label="头节点id" prop="hid">
                      <el-input v-model="formLabelAlign.hid" clearable />
                    </el-form-item>
                    <el-form-item label="尾节点id" prop="tid">
                      <el-input v-model="formLabelAlign.tid" clearable />
                    </el-form-item>
                ...
                <my-dialog
                  ...
                  @cancel="dialogClose"
                >
                  <el-form ref="ruleForm6" :label-position="labelPosition" label-width="120px" :model="formLabelAlign" :rules="rules">
                ...
                <my-dialog
                  ...
                  @cancel="dialogClose"
                >
                  <el-form ref="ruleForm7" :label-position="labelPosition" label-width="80px" :model="formLabelAlign" :rules="rules">
                    <el-form-item label="边id" prop="id">
                      <el-input v-model="formLabelAlign.id" clearable />
                    </el-form-item>
                  </el-form>
                ...
                <my-dialog
                  ...
                  @cancel="dialogClose"
                >
                  <el-form ref="ruleForm8" :label-position="labelPosition" label-width="120px" :model="formLabelAlign" :rules="rules">
                    <el-form-item label="类型(Type)" prop="rtype">
                      <el-input v-model="formLabelAlign.rtype" clearable />
                    </el-form-item>
                    <el-form-item label="条件(Key:Value)">
            ...
            <el-row>
              ...
              <el-col :span="18">
                ...
                >
                  <input id="xlsxfile" ref="uploadxlsx" type="file" :accept="fileType" @change="xlsxFileChange">
                  <el-table
                    v-loading="loading"
                    :data="tableData"
                    style="width: 100%"
                ...
                >
                  <input ref="uploadshp" type="file" :accept="fileType" @change="shpFileChange">
                  <my-map
                    v-loading="loading"
                    :zoom="1"
                    height="97%"
        ...
        <my-panel title="Relationship Information" theme="background" icon="el-icon-link">
          <my-key-val-list :column="edgecolumn" :data="edgedata" border :columns="1" />
        </my-panel>
      </div>
    </my-map-drawer>
  </div>
